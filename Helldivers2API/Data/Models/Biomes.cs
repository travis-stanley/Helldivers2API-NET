...
namespace Helldivers2API.Data.Models
{
    ...
    public class RainForest : IBiome
    {
    ...
    public class IceMossSpecial : IBiome
    {
    ...
    public class CrimsonMoor : IBiome
    {
